...
export function generateMonthlyDistribution(
  ...
  const academicMonths = [
    { month: 8, year: academicYear.startYear, name: "september" }, // Sept (month 8 in JS)
    { month: 9, year: academicYear.startYear, name: "october" },
    { month: 10, year: academicYear.startYear, name: "november" },
    { month: 11, year: academicYear.startYear, name: "december" },
    { month: 0, year: academicYear.endYear, name: "january" }, // Jan (month 0 in JS)
    { month: 1, year: academicYear.endYear, name: "february" },
    { month: 2, year: academicYear.endYear, name: "march" },
    { month: 3, year: academicYear.endYear, name: "april" },
    { month: 4, year: academicYear.endYear, name: "may" },
    { month: 5, year: academicYear.endYear, name: "june" },
  ];
  ...
  for (const [, group] of eventGroups) {
    const distribution: MonthlyDistributionEntry = {
      groupName: group.groupName,
      september: 0,
      october: 0,
      november: 0,
    ...
    for (const monthInfo of academicMonths) {
      ...
      distribution[monthInfo.name as keyof Omit<MonthlyDistributionEntry, "groupName" | "total">] = hours;
    }
