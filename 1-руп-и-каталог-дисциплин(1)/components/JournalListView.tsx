...
export const JournalListView: React.FC<JournalListViewProps> = ({ onSelectJournal, journals, onOpenScheduleModal, activeYear, activeSemester }) => {
            ...
            <div className="mb-6 flex flex-col gap-4 flex-shrink-0">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 font-medium mt-1">Выберите журнал для работы • {activeYear} • {activeSemester}</p>
                    </div>
                    <button 
