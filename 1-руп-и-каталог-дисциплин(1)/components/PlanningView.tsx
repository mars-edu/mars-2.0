...
export const PlanningView: React.FC<PlanningViewProps> = ({ schedules, onOpenScheduleModal, activeYear, activeSemester }) => {
        ...
        <div className="h-full flex flex-col bg-[#F5F5F7] p-6 md:p-8 overflow-hidden">
            <div className="flex items-center justify-between mb-6 flex-shrink-0">
                <div>
                    ...
                    <p className="text-gray-500 font-medium mt-1">Календарь занятий и мероприятий • {activeYear} • {activeSemester}</p>
                </div>
